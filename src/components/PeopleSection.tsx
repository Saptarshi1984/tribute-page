...
const PeopleSection = () => {
  ...
  return (
    <div>
        ...
        <h1 className='!text-8xl'>Peoples of Bengal</h1>
        <p className='w-[50%] !text-2xl text-gray-400 text-justify '>Bengal Luminaries is a digital tribute to the extraordinary individuals from Bengal 
